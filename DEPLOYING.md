...
```
tanzu apps workload create cloudfusion-tap -f config/workload.yaml \
  --local-path . \
  --source-image harbor-uat.cloudfusion.proximus.com/cloudfusion-tap-source \
  --type web
```
...
```
tanzu apps workload get cloudfusion-tap
```
